export function Home() {
  return (
    <div className="flex gap-8 relative">
      <div className="w-80 h-[41rem] shadown-md rounded-md bg-main-800 flex flex-col p-4 fixed top-28">
        <span>It's</span>
      ...
      <div className="flex-1 h-[200vh] ml-[22rem] flex flex-col gap-4 mb-40">
