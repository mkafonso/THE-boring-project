import { Aside, CompetitionCard, Footer, Header } from "./components";
...
export function App() {
  return (
    <div className="flex">
      ...
      <main className="w-full pl-80">
        <Header />
        <Header />

        <div className="mt-28 max-w-7xl m-auto">
          ...
          <div className="flex flex-col gap-2 items-center my-16 mb-80">
            ...
            <p className="max-w-4xl px-4 text-center">
              ...
              pronunciation: ​[stʁɔmaj][1]), is a Belgian singer, rapper,
              songwriter and producer. He is mostly known for his music blending
